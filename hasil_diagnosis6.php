...
$hasil = mysqli_query( $conn, "SELECT * FROM penyakit WHERE id_penyakit='A06'");
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-11 ml-auto text-left">
			...
			<p>Gangguan panik adalah jenis gangguan kecemasan di mana Anda mengalami serangan ketakutan tiba-tiba yang mencapai puncaknya dalam beberapa menit dan memicu gejala fisik yang intensif. Anda mungkin berpikir bahwa Anda benar-benar dapat kehilangan kendali, mengalami serangan jantung atau bahkan kematian.</p><br/>	
			<span class="title">Solusi :</span><hr> <p>Umumnya pengobatan jangka pendek, terapi perilaku kognitif berfokus pada pengajaran keterampilan khusus untuk secara bertahap kembali ke aktivitas yang pernah Anda dihindari karena kecemasan. Melalui proses ini, gejala Anda akan semakin berkurang.</p>
            <br>
