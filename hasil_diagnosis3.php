...
$hasil = mysqli_query( $conn, "SELECT * FROM penyakit WHERE id_penyakit='A03'");
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-11 ml-auto text-left">
			...
			<p>Fobia spesifik adalah jenis gangguan kecemasan yang ditandai oleh ketakutan yang berlebihan dan tidak rasional terhadap objek atau situasi tertentu.</p><br/>	
			<span class="title">Solusi :</span><hr> <p>Secara aktif mencari pengobatan dan berpartisipasi dalam proses, Membuat komitmen untuk menghadapi kesulitan anda dengan berani, Melakukan latihan relaksasi secara teratur untuk mengurangi gejala kecemasan, Menjaga gaya hidup sehat: makan makanan yang sehat dan seimbang, berolahraga secara teratur dan cukup, mengembangkan hobi yang bermakna, mempertahankan hubungan sosial.</p>
            <br>
