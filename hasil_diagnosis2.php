...
$hasil = mysqli_query( $conn, "SELECT * FROM penyakit WHERE id_penyakit='A02'");
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-11 ml-auto text-left">
			...
			<p>Gangguan kecemasan umum adalah rasa cemas atau khawatir yang berlebihan dan tak terkendali sehingga mengganggu aktivitas sehari-hari penderitanya. Kondisi jangka panjang ini bisa dialami oleh anak-anak maupun orang dewasa.</p><br/>	
			<span class="title">Solusi :</span><hr> <p>Terapi perilaku kognitif (CBT). Diskusikanlah dengan dokter mengenai jenis obat yang cocok untuk kondisi Anda, contohnya durasi pengobatan yang akan dijalani serta efek sampingnya. Beberapa jenis obat yang biasanya diberikan meliputi: Antidepresan, seperti selective serotonin reuptake inhibitor (SSRI) atau serotonin and noradrenaline reuptake inhibitor (SNRI). Pregabalin. Benzodiazepine. Berolahraga dengan teratur, Melakukan teknik relaksasi, seperti yoga, Menghindari kafein, merokok, dan konsumsi minuman keras.</p>
            <br>
