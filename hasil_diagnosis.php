...
$hasil = mysqli_query( $conn, "SELECT * FROM penyakit WHERE id_penyakit='A08'");
      ...
      <div class="container">
        ...
        <div class="row">
          ...
          <div class="col-lg-11 ml-auto text-left">
			...
			<span style="color:#000; font-weight:bold;" name="hasil"><?= $row_hasil['penyakit'] ?></span>
			<p>Tidak ada keterangan.</p><br/>	
			<span class="title">Solusi :</span><hr> <p>Silahkan berkonsultasi langsung dengan psikiater/ pakar.</p>
            <br>
